...
convenient — and confirm the printed volts against a multimeter on the
...
flowing → the shunt sense wires are disconnected.

Do not proceed to the amplifier sketches until the ADC agrees with the
