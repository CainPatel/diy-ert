...
|---|---|---|---|
| 00 | [I2C scanner](00_i2c_scanner/) | ADC is alive at 0x48 | nothing found: check power, SDA/SCL, solder |
...
- Arduino IDE or arduino-cli, with the **Adafruit ADS1X15** library
  installed (Library Manager, search "Adafruit ADS1X15"). Sketches 00,
  02 and 03 need only the core libraries.
...
18 control pins total (16 mux address lines + 2 bridge inputs), which is
the count behind the Nano + 74HC595 migration described in
