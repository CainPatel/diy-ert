...
// driving perfectly well, a false reading that cost real debugging time
// on this build (see docs/failure-log.md). Park the bridge in DC and
// the multimeter becomes trustworthy again.
//
